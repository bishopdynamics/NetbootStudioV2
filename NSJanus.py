...
# Modified Janus Queue
# https://raw.githubusercontent.com/aio-libs/janus/master/janus/__init__.py

# Modifications:
#   add required loop parameter to Queue initializer
#   add extra attributes

# TODO this really should not be necessary, we need to figure out how to do without
...
class Queue(Generic[T]):
    def __init__(self, loop, maxsize: int = 0) -> None:
        self._loop = loop
